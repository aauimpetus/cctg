...
init:
    ...
    ##### Images
    image A = "images/image.png"         # different card images
    image B = "images/image.png"
    image C = "images/UI/coin_icon.png"          # back of the card
...
label memoria_game:
    ...
    "here you have to match 3 same items (three A or three B)"
